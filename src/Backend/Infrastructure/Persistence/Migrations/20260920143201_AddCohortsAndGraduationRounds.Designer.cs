...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260920143201_AddCohortsAndGraduationRounds")]
    partial class AddCohortsAndGraduationRounds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.CohortMajor", b =>
                {
                    ...
                    b.ToTable("CohortMajors", null, t =>
                        {
                            t.HasCheckConstraint("CK_CohortMajors_Counts", "\"StudentCount\" >= 0 AND \"GraduatedCount\" >= 0 AND \"NotGraduatedCount\" >= 0 AND \"ExcellentCount\" >= 0 AND \"VeryGoodCount\" >= 0 AND \"GoodCount\" >= 0 AND \"AverageCount\" >= 0 AND \"WorkStudyCount\" >= 0");
                        });
                });
