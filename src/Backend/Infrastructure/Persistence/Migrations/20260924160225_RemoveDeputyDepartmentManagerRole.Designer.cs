...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260924160225_RemoveDeputyDepartmentManagerRole")]
    partial class RemoveDeputyDepartmentManagerRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.GraduationRoundImportRevision", b =>
                {
                    b.Property<long>("RevisionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("GraduationRoundId", "RevisionNumber")
                        .IsUnique();

                    b.ToTable("GraduationRoundImportRevisions", null, t =>
                        {
                            t.HasCheckConstraint("CK_GraduationRoundImportRevisions_RevisionNumber", "\"RevisionNumber\" > 0");

                            t.HasCheckConstraint("CK_GraduationRoundImportRevisions_RowCounts", "\"SourceRowCount\" = \"ImportedRowCount\" + \"SkippedRowCount\" AND \"ImportedRowCount\" > 0 AND \"SkippedRowCount\" >= 0");
                        });
                });

            modelBuilder.Entity("Domain.GraduationRoundRevisionAggregate", b =>
                {
                    b.Property<long>("AggregateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("AggregateId"));
                    ...
                    b.ToTable("GraduationRoundRevisionAggregates", null, t =>
                        {
                            t.HasCheckConstraint("CK_GraduationRoundRevisionAggregates_StudentCount", "\"StudentCount\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Domain.GraduationRound", b =>
                {
                    ...
                    b.HasOne("Domain.GraduationRoundImportRevision", null)
                        .WithMany()
                        .HasForeignKey("ActiveRevisionId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
