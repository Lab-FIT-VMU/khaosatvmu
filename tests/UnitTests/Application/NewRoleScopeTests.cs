...
public class NewRoleScopeTests
{
    ...
    [Fact]
    public void DepartmentManager_ScopesByDepartment()
    {
    ...
    [InlineData(RoleCodes.FacultyManager, "Quản lý khoa", "KV")]
    [InlineData(RoleCodes.DepartmentManager, "Quản lý bộ môn", "BM")]
